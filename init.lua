...
-- Ensure 'y' and other yank commands copy/paste directly to keyboard
...
--    Uses Neovim's builtin plugin manager `vim.pack` (see `:h vim.pack`).
--
--  To update plugins, run
--    :lua vim.pack.update()
--  then review the changes: `:write` applies them, `:quit` discards them.
--
